...
extern uint64 sys_readsensors(void);
extern uint64 sys_setsensorthreshold(void);
...
[SYS_readsensors]        sys_readsensors,
[SYS_setsensorthreshold] sys_setsensorthreshold,
};
